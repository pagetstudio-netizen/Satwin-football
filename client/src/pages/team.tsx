...
export default function TeamPage() {
  ...
  const iconBtns: { img: string; filter: string; label: string; to: View }[] = [
    { img: iconTeam,     filter: "grayscale(100%) brightness(0.55)",                      label: "Mon équipe",         to: "mon_equipe" },
    { img: iconRapport,  filter: "brightness(0) opacity(0.55)",                           label: "Rapport",            to: "rapport"    },
    { img: iconDossiers, filter: "invert(1) grayscale(100%) brightness(0) opacity(0.55)", label: "Dossiers",           to: "dossiers"   },
    { img: iconCode,     filter: "grayscale(100%) brightness(0.55)",                      label: "Code\nd'invitation", to: "code"       },
  ];
